...
month_of = MonthName( Month( DateAdd("m",+1,date()) ) )
namefile = "Provision_List_Report_" & date_name & "(" & month_of & ")" &".xlsx"
...
Fso.MoveFile path & "\bin\" & "production_demand.xlsx" , path & "\bin\" & namefile
